...
export const MELI_CLASSES = {
    ...
    priceMELI: ".price-tag-fraction",
    produMELI_URL: ".ui-search-result__image",
}
...
export const DB_CLASSES = {
    ...
    titleBD: ".title",
    priceBD: ".sale-price",
    produMELI_URL: ".item-img > a"
}

export const MELI_URL = "https://www.mercadolibre.com.ar/"

export const DB_URL = "https://www.bookdepository.com/"